...
class UtilisateursControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create utilisateur" do
    assert_difference('Utilisateur.count') do
      post utilisateurs_url, params: { utilisateur: { Age: @utilisateur.Age, City: @utilisateur.City, Name: @utilisateur.Name } }
    end
  ...
  test "should update utilisateur" do
    patch utilisateur_url(@utilisateur), params: { utilisateur: { Age: @utilisateur.Age, City: @utilisateur.City, Name: @utilisateur.Name } }
